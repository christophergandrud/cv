...
\begin{itemize}
    \item \textbf{AI Evaluation and Fine tuning} Lead teams of ML engineers and data scientists to build AI evaluation systems (including LLMs as Judges) and refine the ML reward functions and generative recommendations systems powering recommendations.  
    \item \textbf{Connecting Product Metrics to Business Outcomes}: Built measurement systems aligning short-term engagement signals with long-term retention and revenue, eliminating guesswork and accelerating decision velocity across recommendation surfaces.
