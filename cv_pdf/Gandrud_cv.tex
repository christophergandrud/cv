...
\subsubsection*{Head of Content Performance Algorithims (Economics Lead prior to January 2019)}

I lead an international set of seams of economists, machine learning experts, and backend engineers, researching, developing, and deploying cutting-edge systems for large scale decision-making. In particular, we are developing a real-time auction system for content placement on the Zalando website, as well as leading an effort to improve attribution modelling.

\subsection*{Harvard University Institute for Quantitative Social Science (2017)}

\subsubsection*{Research Fellow}

With Prof. Gary King, I developed statistical software and statistical software best practices for a wide range of social science applications. I also taught short courses on data science and data visualisation best practices.
...
\begin{itemize}
    ...
    \item Dynamic Web Documents with Dashboards and Shiny (taught with Dustin Tingley)
\end{itemize}
