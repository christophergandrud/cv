...
\begin{itemize}
  ...
  \item \textbf{Measuring the right things}: I lead a team of data scientists, economists, and product managers redeveloping the company's KPI framework.

  \item \textbf{Measuring incremental impact}: I lead the development of Zalando's A/B testing platform and broader program to enable teams to measure their incremental impact with causal inference methods. I guide research into new statstical methods and their application in the Zalando business context.

  \item I led the development of Zalando's \textbf{real-time ad auction and machine learned content recommendation system}. We created a platform that dramatically expanded Zalando's advertising business.
