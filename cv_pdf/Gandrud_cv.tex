...
\begin{itemize}
  ...
  \item \textbf{Measuring incremental impact}: I lead the development of Zalando's A/B testing platform and broader program to enable teams throughout the company to measure their incremental impact with causal and Bayesian inference methods. I guide research into new statstical methods and their application in the Zalando business context.
...
\begin{itemize}
    ...
    \item Taking Time (and Space) Seriously: How Scholars Falsely Infer Policy Diffusion from Model Misspecification. With Cody A. Drolc and Laron K. Williams. Forthcoming at \emph{Policy Studies Journal}.
...
\begin{itemize}
    \item Reproducible Research with R and RStudio. 2020 (forthcoming). Third Edition. {\emph{Chapman \& Hall/CRC Press division of the Taylor \& Francis Group}}.
