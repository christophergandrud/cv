...
\subsubsection*{Head of Experimentation and Economics (Economics Team Lead prior to January 2019)}

I lead an international team of economists, machine learning scientists, and backend engineers, researching, developing, and deploying cutting-edge systems for data driven real-time and company strategic decision-making.

\begin{itemize}
  \item Lead the development of Zalando's \textbf{A/B testing platform} and research into new strategic key performance indicators.

  \item Guide a team of economists and data engineers that conduct causal inference research on key customer journey events. This research \textbf{guides company strategy} on investments for developing deep and enduring relationships.

  \item Previously, I led the project that built Zalando's \textbf{real-time ad auction and content recommendation system}.
...
\begin{itemize}
    ...
    \item Taking Time (and Space) Seriously: How Scholars Falsely Infer Policy Diffusion from Model Misspecification. With Cody A. Drolc and Laron K. Williams. Conditionally accepted at \emph{Policy Studies Journal}.
    ...
    \item The Measurement of Real-Time Perceptions of Financial Stress: Implications for Political Science. With Mark Hallerberg. 2017. \emph{British Journal of Political Science}.
...
\begin{itemize}
    \item Reproducible Research with R and RStudio. 2015. Second Edition {\emph{Chapman \& Hall/CRC Press division of the Taylor \& Francis Group}}.
        ...
        \begin{itemize}
            ...
            \item Third edition under contract.
        \end{itemize}
...
I am a highly skilled user of AWS, Bash, CSS, Git/GitHub, HTML, JAGS, JavaScript, Julia, knitr, LaTeX, Linux, SQL, Python, R, Shiny web apps, SPSS, Stan, and Stata.
