...
\begin{document}
    ...
    \begin{flushright}
        ...
        Head of Experimentation and Economics \\
        {\bf{\large{Zalando SE}}} \\
...
I lead an international team of economists, machine learning scientists, and backend engineers, researching, developing, and deploying cutting-edge systems for \textbf{data driven real-time and company strategic decision-making}.

\begin{itemize}
  \item Lead the development of Zalando's in-house \textbf{A/B} testing platform.
  ...
  \item Built a set of teams that created Zalando's \textbf{real-time ad auction and content recommendation system}. This system transformed Zalando into the platform for fashion content in Europe.
