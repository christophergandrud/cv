...
\begin{itemize}
  ...
  \item \textbf{Measuring the right things}: I lead the redevelopment of the company's KPI framework, bringing together expertise from economics, data science and product.

  \item \textbf{Measuring incremental impact}: I lead the development of Zalando's \textbf{A/B testing platform} and broader program to enable teams to measure their incremental impact with causal inference methods. I guide research into new statstical methods and their application in the Zalando business context.

  \item I led the development of Zalando's \textbf{real-time ad auction and machine learned content recommendation system}. We created a platform that has dramatically expanded Zalando's advertising business.
