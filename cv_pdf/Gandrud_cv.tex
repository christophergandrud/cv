...
\begin{itemize}
  ...
  \item I lead the development of a \textbf{real-time ad auction and content recommendation system} that is transforming Zalando into the platform for fashion content in Europe.

  \item I lead the fundamental research on key customer journey events. This research \textbf{guides company strategy} on investments for developing deep and enduring relationships.
\end{itemize}
